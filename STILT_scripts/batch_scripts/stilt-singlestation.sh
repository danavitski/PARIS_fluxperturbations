...
Rscript stilt_loop_dense_and_sparse.r --sparse --filter-times --overwrite-localization --station $station --nhrs 240 --npars 250 --path $path --rundir $rundir --sourcepath $sourcepath >> "${subdir}STILT_log"
